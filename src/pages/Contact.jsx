    ...
    <div className="my-36 flex-col flex shadow-lg bg-gradient-to-br from-sky-600 to-indigo-700 rounded-xl w-1/2">
      ...
      <form className="form flex-col">
        <div className="p-2">
          <label>Name:</label>
          <input
            className="form-input rounded-lg w-full text-slate-700"
            value={name}
            type="text"
            name="name"
        ...
        <div className="p-2">
          <label>Email:</label>
          <input
            className="align-middle form-input rounded-lg w-full text-slate-700"
            value={email}
            type="email"
            name="email"
        ...
        <div className="p-2">
          <label>Message:</label>
          <textarea
            className="form-textarea rounded-lg w-full text-slate-700"
            value={message}
            name="message"
        ...
        <button
          className="rounded-lg place-self-center m-2 p-1 bg-indigo-900 text-slate-300"
          type="submit"
