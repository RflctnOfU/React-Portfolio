  ...
  return (
    <div className="my-20 mb-16 pl-9">
      <div className="leading-7" style={{ textShadow: "5px 5px 5px #292524" }}>
        ...
        <div className="">
          <div>
            <h2 className="text-4xl text-slate-400 antialiased">
              Proficiencies
            </h2>
          </div>
          <br />
          <div>
            ...
            <span className="text-lg text-slate-400 antialiased">
              HTML5, CSS3, JavaScript, jQuery, React, Handlebars
            </span>
            <div>
              <img
                src="images/html5.png"
                alt="html-icon"
                className="h-12 inline px-1"
              />
              <img
                src="images/css3.png"
                alt="css-icon"
                className="h-12 inline px-3"
              />
              <img
          ...
          <div>
            ...
            <div>
              ...
              <img
                ...
                alt="mongodb-icon"
                className="h-12 inline px-4"
              />
              <img
                src="images/npm.png"
                alt="npm-icon"
                className="h-12 inline px-2"
              />
            </div>
          </div>
        </div>
